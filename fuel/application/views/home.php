...
<body>
	...
	<div id="container">
		...
		<div id="content">
			...
			<p>This site is built using FUEL CMS and CodeIgniter 2.0. If you are familiar with installing CodeIgniter, then many of the following steps will seem familiar to you.</p>
			...
			<ol>
				...
				<li>Install the database by first creating the database in MySQL and then inport <strong>fuel/install/webauction.sql</strong>.
				...
				so that the website can connect to your database</li>
				<li>Have a look at the basic config options in fuel/application/config/config.php, at the top are the main WebAuction variables, but it may be worth checking all the other options too.</li>
				...
				pwd: <strong>admin</strong> </li>
				<li>Once you are done with these instructions, find this view file at /fuel/application/views/home.php and delete it, at the same time rename /fuel/application/views/home2.php to /fuel/application/views/home.php so that the proper home page is showing.<br />
			  </li>
